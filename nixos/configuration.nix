...
# Use this to configure your system environment (it replaces /etc/nixos/configuration.nix)
{
  ...
  nixpkgs = {
    ...
    overlays = [
      ...
      outptus.overlays.packages22 # for quartus
  ...
  users.users = {
    ...
    shob = {
      ...
      initialPassword = "powerranger";
      description = "Config for Shobhit Maheshwari";
      isNormalUser = true;
  ...
  # steam is initialised here as it is so essential
  programs.steam = {
    enable = true;
